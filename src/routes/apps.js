...
router.post('/', async (req, res, next) => {
  try {
    ...
    if (!name || !vendor || !problemType || !rectificationDeadline || !batchId) {
...
router.put('/:id', async (req, res, next) => {
  try {
    ...
    if (rectificationDeadline) updateData.rectificationDeadline = new Date(rectificationDeadline);
